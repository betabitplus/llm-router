# %%
"""Gemini WebAPI PDF structured-output experiment script.
...
Examples:
    Run manually:
        uv run python -m experiments.llm_router.gemini_webapi.pdf_structured
        uv run python scripts/reproduce_running_loop.py \
            experiments.llm_router.gemini_webapi.pdf_structured
"""
...
from experiment_support import extract_expected_pdf_facts
