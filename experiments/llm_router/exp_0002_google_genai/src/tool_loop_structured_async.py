# %%
"""Google GenAI async tool-calling experiment script.
...
Examples:
    Run manually:
        uv run python -m experiments.llm_router.google_genai.tool_loop_structured_async
        uv run python scripts/reproduce_running_loop.py \
            experiments.llm_router.google_genai.tool_loop_structured_async
"""
...
from _sdk_helpers import build_client
from _structured_output import (
    CalculationAudit,
    build_tool_audit_prompt,
)
from _tool_loop import run_async_tool_loop
