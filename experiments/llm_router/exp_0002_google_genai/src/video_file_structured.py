# %%
"""Google GenAI local-video structured-output experiment script.
...
Examples:
    Run manually:
        uv run python -m experiments.llm_router.google_genai.video_file_structured
        uv run python scripts/reproduce_running_loop.py \
            experiments.llm_router.google_genai.video_file_structured
"""
...
from _media_parts import build_video_file_part
...
_VIDEO_PATH = _CAPSULE_ROOT / "inputs/jumper.mp4"
