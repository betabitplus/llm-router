# %%
"""QwenChat experiment chat-completion helpers.
...
When to use:
    Import from QwenChat experiment helpers or scripts that send direct
...
from _uploads import QwenUserContent
...
class QwenUsageSummary(TypedDict):
    """Normalized token-count evidence for experiment output."""
