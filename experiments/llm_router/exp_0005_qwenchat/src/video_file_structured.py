# %%
"""QwenChat uploaded-video structured experiment script.
...
Examples:
    Run manually:
        uv run python -m experiments.llm_router.qwenchat.video_file_structured
        uv run python scripts/reproduce_running_loop.py \
            experiments.llm_router.qwenchat.video_file_structured
"""
...
from _structured_output import VideoObservation
from _structured_runner import (
    StructuredRunConfig,
    run_structured_sync,
)
from _uploads import build_user_content_sync
from experiment_support import get_llm_router_test_data_path
