# %%
"""QwenChat experiment upload and content-assembly helpers.
...
When to use:
    Import from QwenChat experiment helpers or scripts that upload files or
...
import httpx
from _runtime import api_key_env_name, upload_url
...
def build_user_content_sync(
    *,
    ...
    """Flatten role-less experiment items into one QwenChat user content value."""
