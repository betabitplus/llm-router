# %%
"""QwenChat experiment structured-output runner helpers.
...
When to use:
    Import from QwenChat experiment scripts that need prompt-enforced
...
def _attempt_items(
    *,
    ...
    """Build the experiment items for one structured-output attempt."""
