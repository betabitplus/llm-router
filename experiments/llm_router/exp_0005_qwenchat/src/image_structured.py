# %%
"""QwenChat image structured-output experiment script.
...
Examples:
    Run manually:
        uv run python -m experiments.llm_router.qwenchat.image_structured
        uv run python scripts/reproduce_running_loop.py \
            experiments.llm_router.qwenchat.image_structured
"""
