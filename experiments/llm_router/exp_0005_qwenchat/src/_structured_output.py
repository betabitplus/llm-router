# %%
"""QwenChat experiment structured-output helpers.

Why:
    Keeps shared schema models, prompts, and JSON validation helpers in one
    place so the QwenChat experiment scripts stay focused on one provider seam.

When to use:
    Import from QwenChat experiment scripts that need prompt-enforced JSON
