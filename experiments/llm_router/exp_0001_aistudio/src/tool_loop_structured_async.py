# %%
"""AI Studio async tools-plus-structured experiment script.
...
Examples:
    Run manually:
        uv run python -m experiments.llm_router.aistudio.tool_loop_structured_async
        uv run python scripts/reproduce_running_loop.py \
            experiments.llm_router.aistudio.tool_loop_structured_async
"""
...
from _sdk_helpers import build_async_client
