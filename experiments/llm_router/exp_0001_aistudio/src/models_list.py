# %%
"""AI Studio model-list experiment script.
...
Examples:
    Run manually:
        uv run python -m experiments.llm_router.aistudio.models_list
        uv run python scripts/reproduce_running_loop.py \
            experiments.llm_router.aistudio.models_list
"""
...
# exact model catalog the rest of the AI Studio experiment scripts depend on.
...
def main() -> None:
    ...
    console.demo_step(
        ...
        "OpenAI-compatible base URL the other AI Studio experiment probes use.",
        details=(
