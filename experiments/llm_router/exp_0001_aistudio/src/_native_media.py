# %%
"""AI Studio native-media experiment helpers.
...
Why:
    ...
    The experiment keeps that protocol in one place so the PDF and video scripts
    stay small and readable.

When to use:
    Import from AI Studio experiment scripts that need native PDF, local-video,
