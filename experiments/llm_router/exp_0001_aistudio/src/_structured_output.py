# %%
"""AI Studio experiment structured-output models and prompts.

Why:
    Keeps reusable AI Studio experiment schemas and prompts together so the
    executable scripts stay focused on one provider seam at a time.

When to use:
    Import from AI Studio experiment scripts that need a prompt plus one local
