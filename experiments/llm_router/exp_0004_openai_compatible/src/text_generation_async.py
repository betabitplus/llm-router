# %%
"""OpenAI-compatible async text-generation experiment script.
...
Examples:
    Run manually:
        uv run python -m experiments.llm_router.openai.text_generation_async
        uv run python scripts/reproduce_running_loop.py \
            experiments.llm_router.openai.text_generation_async
"""
