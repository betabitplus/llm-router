# %%
"""OpenAI-compatible async retry text-generation experiment script.
...
Examples:
    Run manually:
        uv run python -m experiments.llm_router.openai.retry_text_generation_async
        uv run python scripts/reproduce_running_loop.py \
            experiments.llm_router.openai.retry_text_generation_async
"""
