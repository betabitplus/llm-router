# %%
"""OpenAI-compatible experiment structured-output helpers.

Why:
    Keeps reusable JSON-schema payloads in one place so each experiment script
    can stay about one provider seam instead of re-declaring large schemas.

When to use:
    Import from OpenAI-compatible experiment scripts that need one response
