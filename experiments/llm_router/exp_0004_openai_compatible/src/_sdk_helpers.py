# %%
"""Internal OpenAI-compatible experiment SDK helpers.

Why:
    Keeps repeated client creation, response parsing, and image encoding in one
    place so the OpenAI-compatible experiment scripts stay focused on one SDK
    seam each.

When to use:
    Import from OpenAI-compatible experiment scripts that make live SDK
