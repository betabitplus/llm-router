# %%
"""OpenAI-compatible async structured tool-loop experiment script.
...
Examples:
    Run manually:
        uv run python -m experiments.llm_router.openai.tool_loop_structured_async
        uv run python scripts/reproduce_running_loop.py \
            experiments.llm_router.openai.tool_loop_structured_async
"""
...
from _structured_output import TOOL_LOOP_RESPONSE_FORMAT
