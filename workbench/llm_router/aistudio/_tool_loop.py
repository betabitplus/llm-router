...
When to use:
    Import from AI Studio workbench scripts that need forced tool choice or
...
from workbench.llm_router.aistudio._sdk_helpers import parse_message_json, response_text
