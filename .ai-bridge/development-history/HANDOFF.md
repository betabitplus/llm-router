...
Он не заменяет repository state и не заменяет историю 001–039. Его задача — передать то, что новому человеку опаснее всего потерять: **ментальную модель, принятые границы, инварианты, UX-требования и выученные уроки**.
