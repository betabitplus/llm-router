...
Он не заменяет repository state и не заменяет историю 001–040. Его задача — передать то, что новому человеку опаснее всего потерять: **ментальную модель, принятые границы, инварианты, UX-требования и выученные уроки**.
...
Не обязательно читать 001–040 подряд.
