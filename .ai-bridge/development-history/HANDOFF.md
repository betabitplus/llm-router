...
Образец того, как глубоко прорабатывать страницу, — эталоны в [`../exemplars/`](../exemplars/README.md); первый из них — [Verification Maps](../exemplars/001-verification-maps.md) с чек-листом для следующих страниц.
