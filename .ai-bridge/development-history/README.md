...
Там собраны текущая ментальная модель, ownership, ключевые invariants, роли views, UX-правила, сознательно отвергнутые подходы и checklist перед изменениями. История 001–042 нужна уже как объяснение, **почему** эти решения появились и как они менялись.
