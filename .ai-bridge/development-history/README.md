...
Там собраны текущая ментальная модель, ownership, ключевые invariants, роли views, UX-правила, сознательно отвергнутые подходы и checklist перед изменениями. История 001–044 нужна уже как объяснение, **почему** эти решения появились и как они менялись.
...
44. [044 — Verification Health Map: одна страница вместо трёх](entries/044-2026-09-26-verification-health-map-one-page.md)
