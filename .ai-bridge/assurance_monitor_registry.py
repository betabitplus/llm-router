...
PAGE_SPECS = (
    ...
    PageSpec(
        entity_id="FEAT_PROVIDER_RETRY",
        page_title="Capability Assurance",
        facts_path=("features", "FEAT_PROVIDER_RETRY"),
        output="assurance-feat-provider-retry.html",
        labels=FEATURE_SECTION_LABELS,
        profile_source="docs/assurance-profiles/resilience.md",
        profile_url="assurance-profiles/resilience.html",
    ),
    PageSpec(
        entity_id="FEAT_STRUCTURED_RECOVERY",
        page_title="Capability Assurance",
        facts_path=("features", "FEAT_STRUCTURED_RECOVERY"),
        output="assurance-feat-structured-recovery.html",
        labels=FEATURE_SECTION_LABELS,
        profile_source="docs/assurance-profiles/resilience.md",
        profile_url="assurance-profiles/resilience.html",
    ),
    PageSpec(
        entity_id="GOAL_RESILIENT_EXECUTION",
        page_title="Outcome Assurance",
        facts_path=("goals", "GOAL_RESILIENT_EXECUTION"),
        output="assurance-goal-resilient-execution.html",
        labels=GOAL_SECTION_LABELS,
        profile_source="docs/assurance-profiles/resilience.md",
        profile_url="assurance-profiles/resilience.html",
    ),
    PageSpec(
        entity_id="FEAT_PROVIDER_INTEROPERABILITY",
        page_title="Capability Assurance",
        facts_path=("features", "FEAT_PROVIDER_INTEROPERABILITY"),
        output="assurance-feat-provider-interoperability.html",
        labels=FEATURE_SECTION_LABELS,
        profile_source="docs/assurance-profiles/providers.md",
        profile_url="assurance-profiles/providers.html",
    ),
    PageSpec(
        entity_id="FEAT_ASYNC_EXECUTION",
        page_title="Capability Assurance",
        facts_path=("features", "FEAT_ASYNC_EXECUTION"),
        output="assurance-feat-async-execution.html",
        labels=FEATURE_SECTION_LABELS,
        profile_source="docs/assurance-profiles/providers.md",
        profile_url="assurance-profiles/providers.html",
    ),
    PageSpec(
        entity_id="FEAT_PUBLIC_RESPONSE_CONTRACT",
        page_title="Capability Assurance",
        facts_path=("features", "FEAT_PUBLIC_RESPONSE_CONTRACT"),
        output="assurance-feat-public-response-contract.html",
        labels=FEATURE_SECTION_LABELS,
        profile_source="docs/assurance-profiles/providers.md",
        profile_url="assurance-profiles/providers.html",
    ),
    PageSpec(
        entity_id="GOAL_PROVIDER_PORTABILITY",
        page_title="Outcome Assurance",
        facts_path=("goals", "GOAL_PROVIDER_PORTABILITY"),
        output="assurance-goal-provider-portability.html",
        labels=GOAL_SECTION_LABELS,
        profile_source="docs/assurance-profiles/providers.md",
        profile_url="assurance-profiles/providers.html",
    ),
    PageSpec(
        entity_id="FEAT_CONFIGURATION_PRECEDENCE",
        page_title="Capability Assurance",
        facts_path=("features", "FEAT_CONFIGURATION_PRECEDENCE"),
        output="assurance-feat-configuration-precedence.html",
        labels=FEATURE_SECTION_LABELS,
        profile_source="docs/assurance-profiles/configuration.md",
        profile_url="assurance-profiles/configuration.html",
    ),
    PageSpec(
        entity_id="GOAL_CONFIGURATION_PREDICTABILITY",
        page_title="Outcome Assurance",
        facts_path=("goals", "GOAL_CONFIGURATION_PREDICTABILITY"),
        output="assurance-goal-configuration-predictability.html",
        labels=GOAL_SECTION_LABELS,
        profile_source="docs/assurance-profiles/configuration.md",
        profile_url="assurance-profiles/configuration.html",
    ),
    PageSpec(
        entity_id="FEAT_STRUCTURED_OUTPUT",
        page_title="Capability Assurance",
        facts_path=("features", "FEAT_STRUCTURED_OUTPUT"),
        output="assurance-feat-structured-output.html",
        labels=FEATURE_SECTION_LABELS,
        profile_source="docs/assurance-profiles/structured-output.md",
        profile_url="assurance-profiles/structured-output.html",
    ),
    PageSpec(
        entity_id="GOAL_RICH_INPUT_OUTPUT",
        page_title="Outcome Assurance",
        facts_path=("goals", "GOAL_RICH_INPUT_OUTPUT"),
        output="assurance-goal-rich-input-output.html",
        labels=GOAL_SECTION_LABELS,
        profile_source="docs/assurance-profiles/structured-output.md",
        profile_url="assurance-profiles/structured-output.html",
    ),
