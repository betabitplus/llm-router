...
:affects: REQ_PROVIDER_RETRY, TREQ_PROVIDER_RETRY_CLASSIFICATION, REQ_SYNC_ROUTE_FALLBACK, REQ_ROUTE_ATTEMPT_LIMIT, IMPL_PROVIDER_RETRY, IMPL_PROVIDER_RETRY_CLASSIFICATION, IMPL_SYNC_ROUTE_FALLBACK, IMPL_ROUTE_ATTEMPT_LIMIT
